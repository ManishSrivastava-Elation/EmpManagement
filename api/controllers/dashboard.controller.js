...
export const getDashboardStats = async (req, res) => {
  try {
    // Handle both company token (companyId) and employee token (CompanyId)
    ...
    // Employees table: company_id, status (ACTIVE/INACTIVE) — no Role or IsActive column
    ...
    // Expenses table uses PascalCase: CompanyId, ExpenseDate, Amount, Status
...
// ─────────────────────────────────────────────
// 2. EXPENSE BY TYPE (for bar chart)
// ─────────────────────────────────────────────
export const getExpenseByType = async (req, res) => {
  try {
    ...
    // Expenses table: CompanyId, ExpenseDate, Amount, Title (PascalCase)
