...
import { ProfileForm, useProfileForm } from '@/components/employees/profile/edit';
...
export default function EditProfile() {
  ...
  const { formData, errors, isLoading, updateField, handleSubmit } = useProfileForm(initialProfile);
