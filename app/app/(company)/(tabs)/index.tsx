...
import { getCompanyProfile } from '@/services/company/company.service';
...
export default function CompanyDashboard() {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      const [statsRes, chartRes, profileRes] = await Promise.all([
      ...
      if (profileRes?.success && profileRes.data?.company_name) {
  ...
  return (
    <SafeAreaView style={styles.container} edges={['bottom', 'left', 'right']}>
      {/* <View style={styles.headerTitleContainer}>
        ...
        <Text style={styles.subTitleText}>Welcome to your management dashboard</Text>
      </View> */}
