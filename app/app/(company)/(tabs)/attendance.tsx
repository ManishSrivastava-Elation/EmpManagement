...
import { fmtDate, parseAttendanceRecords, toDateObj } from '@/utils/attendanceHelpers';
...
export default function AttendanceScreen() {
  ...
  const listDays = useMemo(() => {
    const dayMap: Record<string, { date: Date; punches: DayCardPunch[]; employeeName?: string; employeeCode?: string }> = {};
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerActions}>
          <TouchableOpacity onPress={() => setShowReport(true)} activeOpacity={0.8}>
            <LinearGradient colors={['#6b6d71', '#4b5563']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={styles.reportBtn}>
...
const styles = StyleSheet.create({
  ...
  reportBtn: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 10, paddingVertical: 6, borderRadius: 20 },
