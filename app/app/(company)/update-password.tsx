...
import { updateCompanyPassword } from '@/services/company/company.service';
...
export default function UpdateCompanyPasswordScreen() {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const res = await updateCompanyPassword({
