...
import { LABEL_COLOR, SORT_OPTIONS, VALUE_COLOR, type ActiveFilters } from './constants';
import { theme } from '@/theme';
import CustomerDropdown from './new/CustomerDropdown';
        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.body}>
          ...
          <View style={styles.chipRow}>
            {([
              ...
              >
                <Text style={[styles.chipText, draft.priority === p.value && styles.chipTextActive]}>
                  {p.label}
                </Text>
              </TouchableOpacity>
            ))}
          ...
          <CustomerDropdown
            ...
            onChange={(val) => onChange({ ...draft, customer_id: val || '' })}
          />
...
const styles = StyleSheet.create({
  ...
  btnApply: {
    ...
    backgroundColor: '#1B2E6F', alignItems: 'center', justifyContent: 'center',
  },
