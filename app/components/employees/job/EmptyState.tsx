...
import { LABEL_COLOR } from '@/components/company/jobs/constants';
...
const EmptyState = memo(({ error, hasFilters, onRetry }: Props) => {
  if (error) {
    return (
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>
        {hasFilters ? 'Try adjusting your search or filters.' : 'No jobs have been assigned to you yet.'}
      </Text>
      <TouchableOpacity style={styles.btn} onPress={onRetry}>
...
const styles = StyleSheet.create({
  ...
  btn: { marginTop: 8, backgroundColor: '#1B2E6F', paddingHorizontal: 24, paddingVertical: 10, borderRadius: 8 },
