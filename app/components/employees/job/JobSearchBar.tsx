...
import { BG, LABEL_COLOR, VALUE_COLOR } from '@/components/company/jobs/constants';
...
const JobSearchBar = memo(({ searchQuery, onSearchChange, onClearSearch, activeFilterCount, totalJobs, onOpenFilter }: Props) => (
    ...
    <View style={styles.searchRow}>
      <View style={styles.searchBox}>
        ...
        <TextInput
          ...
          placeholder="Search job title, customer name..."
      ...
      >
        <Ionicons name="options-outline" size={20} color={activeFilterCount > 0 ? theme.colors.white : '#1B2E6F'} />
        {activeFilterCount > 0 && (
...
const styles = StyleSheet.create({
  ...
  filterBtnActive: { backgroundColor: '#1B2E6F', borderColor: '#1B2E6F' },
  badge: {
  ...
  recordsLabel: { fontSize: 12, fontWeight: '700', color: LABEL_COLOR, letterSpacing: 0.3, marginBottom: 8 },
});
